...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.dont_have_an_acc).setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    private void verifyEmail() {
        ...
        if(user.isEmailVerified()) {
            ...
            if (bol) {
                ...
                startActivity(new Intent(LoginActivity.this, com.example.myvotingapplication.HomeActivity.class));
                finish();
                ...
                //first we send email for verification
                //store data in shared preferences if user verify email
                //and login then we upload data to Firestore and save image Firebase Storage
